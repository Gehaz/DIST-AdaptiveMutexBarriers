...
The TSO model allows a process to have at most a single write operation per variable in its write buffer at any given time. As a result, during a fence execution,
